...
class SignInUpActivity :
    ...
    override fun onSuccessString(message: String) {
        ...
        if (loginGoogleUtil.isEmailVerfied(mAuth.currentUser)) {
            Log.d("Lihat", "onSuccessString SignInUpActivity : " + mAuth.currentUser!!.displayName)
            Log.d("Lihat", "onSuccessString SignInUpActivity : " + mAuth.currentUser!!.phoneNumber)
            Log.d("Lihat", "onSuccessString SignInUpActivity : " + mAuth.currentUser!!.email)
            Log.d("Lihat", "onSuccessString SignInUpActivity : " + mAuth.currentUser!!.providerData)
            Log.d("Lihat", "onSuccessString SignInUpActivity : " + mAuth.currentUser!!.providerId)
            showSnackbar(message)
