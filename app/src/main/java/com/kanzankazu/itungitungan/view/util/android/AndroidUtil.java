package com.kanzankazu.itungitungan.view.util.android;
...
public class AndroidUtil {
    ...
    public static String pickContactResult(Activity activity, int requestCode, int resultCode, Intent data, boolean isPhoneNoElseName) {
    ...
    public static String pickEmailAccountResult(Activity activity, int requestCode, int resultCode, Intent data) {
